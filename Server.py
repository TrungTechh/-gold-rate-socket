...
from PySide2.QtCore import (QCoreApplication, QPropertyAnimation, QDate, QDateTime, QMetaObject, QObject, QPoint, QRect, QSize, QTime, QUrl, Qt, QEvent,QFile, Slot, Signal)
...
"color: rgb(140, 167, 200);")
    ...
    def retrans(self):
        ...
        self.label_10.setText(QCoreApplication.translate("Form", u"<strong> Created: </strong> Trung Hoang & Tan Phuong", None))
    def progress(self):
...
"background-color: rgb(230, 179, 255);")
    ...
    def retranslateUi(self):
        ...
        self.label_3.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#fbbeff;\">IP: </span></p></body></html>", None))
        self.label_4.setText(QCoreApplication.translate("Form", u"<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#fbbeff;\">PORT: </span></p></body></html>", None))
    ...
    def accept_incoming_connections(self):
        while True:
            ...
            t = Thread(target=self.handle_loop, args=(client,))
            t.setDaemon(True)
            t.start()
            time.sleep(0.1)
...
##################################################################################################
            ...
            if choice == LOGIN:
                ...
                try:
                    con1 =  mysql.connector.connect(host="localhost", user="root", password="Tuilawibu123@", database="gold_infor")
                    cur1 = con1.cursor()
